...
namespace blueshot.Plugin.ExternalCommand; 
	partial class SettingsForm {
		...
		private void InitializeComponent() {
			...
			this.button_new = new blueshotButton();
			this.button_delete = new blueshotButton();
			this.button_edit = new blueshotButton();
			this.SuspendLayout();
			// 
			// buttonCancel
			// 
		...
		private blueshotButton button_edit;
		private blueshotButton button_delete;
		private blueshotButton button_new;
