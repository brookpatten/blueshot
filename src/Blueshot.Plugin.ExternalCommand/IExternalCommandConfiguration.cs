...
[Description("blueshot ExternalCommand Plugin configuration")]
public interface IExternalCommandConfiguration : IIniSection, IAfterLoad
{
    ...
    [Description("Redirect the standard error of all external commands, used to output as warning to the blueshot.log.")]
    [DefaultValue(true)]
    ...
    [Description("Depends on 'RedirectStandardOutput': Show standard output of all external commands to the blueshot log, this can be useful for debugging.")]
    [DefaultValue(false)]
