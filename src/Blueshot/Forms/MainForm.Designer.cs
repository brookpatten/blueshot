...
namespace blueshot.Forms {
	partial class MainForm {
		...
		private void InitializeComponent() {
            ...
            this.contextmenu_capturearea = new blueshotToolStripMenuItem();
			this.contextmenu_capturelastregion = new blueshotToolStripMenuItem();
			this.contextmenu_capturewindow = new blueshotToolStripMenuItem();
			this.contextmenu_capturefullscreen = new blueshotToolStripMenuItem();
			this.contextmenu_capturewindowfromlist = new blueshotToolStripMenuItem();
			this.contextmenu_captureclipboard = new blueshotToolStripMenuItem();
			this.contextmenu_openfile = new blueshotToolStripMenuItem();
			this.contextmenu_openrecentcapture = new blueshotToolStripMenuItem();
			this.contextmenu_quicksettings = new blueshotToolStripMenuItem();
			this.contextmenu_settings = new blueshotToolStripMenuItem();
			this.contextmenu_help = new blueshotToolStripMenuItem();
			this.contextmenu_donate = new blueshotToolStripMenuItem();
			this.contextmenu_about = new blueshotToolStripMenuItem();
            this.contextmenu_exit = new blueshotToolStripMenuItem();
			...
			this.contextMenu.Renderer = new blueshot.Controls.ContextMenuToolStripProfessionalRenderer(this);
			// 
		...
		private blueshotToolStripMenuItem contextmenu_capturewindowfromlist;
		private System.Windows.Forms.ToolStripSeparator toolStripListCaptureSeparator;
		private blueshotToolStripMenuItem contextmenu_openrecentcapture;
		private blueshotToolStripMenuItem contextmenu_donate;
		private blueshotToolStripMenuItem contextmenu_openfile;
		private System.Windows.Forms.ToolStripSeparator toolStripPluginSeparator;
		private blueshotToolStripMenuItem contextmenu_captureclipboard;
		private blueshotToolStripMenuItem contextmenu_quicksettings;
		private System.Windows.Forms.ToolStripSeparator toolStripMiscSeparator;
		private blueshotToolStripMenuItem contextmenu_help;
		private blueshotToolStripMenuItem contextmenu_capturewindow;
		private System.Windows.Forms.ToolStripSeparator toolStripOpenFolderSeparator;
		private blueshotToolStripMenuItem contextmenu_about;
		private blueshotToolStripMenuItem contextmenu_capturefullscreen;
		private blueshotToolStripMenuItem contextmenu_capturelastregion;
		private blueshotToolStripMenuItem contextmenu_capturearea;
		private System.Windows.Forms.NotifyIcon notifyIcon;
		private System.Windows.Forms.ToolStripSeparator toolStripCloseSeparator;
		private blueshotToolStripMenuItem contextmenu_exit;
		private System.Windows.Forms.ContextMenuStrip contextMenu;
		private blueshotToolStripMenuItem contextmenu_settings;
	}
}
