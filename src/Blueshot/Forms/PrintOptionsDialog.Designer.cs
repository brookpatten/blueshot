...
namespace blueshot.Forms
{
	partial class PrintOptionsDialog
	{
		...
		{
			this.checkbox_dontaskagain = new blueshotCheckBox();
			...
			this.button_ok = new blueshotButton();
			this.checkboxDateTime = new blueshotCheckBox();
			this.button_cancel = new blueshotButton();
			...
			this.Text = "blueshot print options";
		...
		private blueshotButton button_cancel;
		private blueshotCheckBox checkboxDateTime;
		private blueshotButton button_ok;
		...
		private blueshotCheckBox checkbox_dontaskagain;
