...
using blueshot.Editor.Configuration;
using blueshot.Editor.Controls;

namespace blueshot.Forms {
	partial class SettingsForm {
		...
		private void InitializeComponent()
		{
			...
			this.textbox_storagelocation = new blueshotTextBox();
			this.label_storagelocation = new blueshotLabel();
			this.settings_cancel = new blueshotButton();
			this.settings_confirm = new blueshotButton();
			this.folderBrowserDialog1 = new System.Windows.Forms.FolderBrowserDialog();
			this.browse = new System.Windows.Forms.Button();
			this.label_screenshotname = new blueshotLabel();
			this.textbox_screenshotname = new blueshotTextBox();
			this.label_language = new blueshotLabel();
			this.combobox_language = new System.Windows.Forms.ComboBox();
			this.combobox_primaryimageformat = new blueshotComboBox();
			this.label_primaryimageformat = new blueshotLabel();
			this.groupbox_preferredfilesettings = new blueshotGroupBox();
			this.btnPatternHelp = new System.Windows.Forms.Button();
			this.checkbox_copypathtoclipboard = new blueshotCheckBox();
			this.checkbox_zoomer = new blueshotCheckBox();
			this.groupbox_applicationsettings = new blueshotGroupBox();
			this.checkbox_autostartshortcut = new blueshotCheckBox();
			this.groupbox_qualitysettings = new blueshotGroupBox();
			this.checkbox_reducecolors = new blueshotCheckBox();
			this.checkbox_alwaysshowqualitydialog = new blueshotCheckBox();
			this.label_jpegquality = new blueshotLabel();
			this.textBoxJpegQuality = new System.Windows.Forms.TextBox();
			this.trackBarJpegQuality = new System.Windows.Forms.TrackBar();
			this.groupbox_destination = new blueshotGroupBox();
			this.checkbox_picker = new blueshotCheckBox();
			...
			this.tab_general = new blueshotTabPage();
			this.groupbox_network = new blueshotGroupBox();
			this.numericUpDown_daysbetweencheck = new System.Windows.Forms.NumericUpDown();
			this.label_checkperiod = new blueshotLabel();
			this.checkbox_usedefaultproxy = new blueshotCheckBox();
			this.groupbox_hotkeys = new blueshotGroupBox();
			this.label_lastregion_hotkey = new blueshotLabel();
			this.lastregion_hotkeyControl = new HotkeyControl();
			this.label_region_hotkey = new blueshotLabel();
			this.label_window_hotkey = new blueshotLabel();
			this.label_fullscreen_hotkey = new blueshotLabel();
			...
			this.tab_capture = new blueshotTabPage();
			this.groupbox_editor = new blueshotGroupBox();
			this.numericUpdownIconSize = new System.Windows.Forms.NumericUpDown();
			this.label_icon_size = new blueshotLabel();
			this.checkbox_editor_match_capture_size = new blueshotCheckBox();
			this.groupbox_windowscapture = new blueshotGroupBox();
			this.colorButton_window_background = new ColorButton();
			this.radiobuttonWindowCapture = new blueshotRadioButton();
			this.radiobuttonInteractiveCapture = new blueshotRadioButton();
			this.combobox_window_capture_mode = new System.Windows.Forms.ComboBox();
			this.groupbox_capture = new blueshotGroupBox();
			this.checkbox_notifications = new blueshotCheckBox();
			this.checkbox_playsound = new blueshotCheckBox();
			this.checkbox_capture_mousepointer = new blueshotCheckBox();
			this.numericUpDownWaitTime = new System.Windows.Forms.NumericUpDown();
			this.label_waittime = new blueshotLabel();
			this.tab_output = new blueshotTabPage();
			this.tab_destinations = new blueshotTabPage();
			this.tab_printer = new blueshotTabPage();
			this.groupBoxColors = new blueshotGroupBox();
			this.checkboxPrintInverted = new blueshotCheckBox();
			this.radioBtnColorPrint = new blueshotRadioButton();
			this.radioBtnGrayScale = new blueshotRadioButton();
			this.radioBtnMonochrome = new blueshotRadioButton();
			this.groupBoxPrintLayout = new blueshotGroupBox();
			this.checkboxDateTime = new blueshotCheckBox();
			this.checkboxAllowShrink = new blueshotCheckBox();
			this.checkboxAllowEnlarge = new blueshotCheckBox();
			this.checkboxAllowRotate = new blueshotCheckBox();
			this.checkboxAllowCenter = new blueshotCheckBox();
			this.checkbox_alwaysshowprintoptionsdialog = new blueshotCheckBox();
			this.tab_plugins = new blueshotTabPage();
			this.groupbox_plugins = new blueshotGroupBox();
			this.listview_plugins = new System.Windows.Forms.ListView();
			this.button_pluginconfigure = new blueshotButton();
			this.tab_expert = new blueshotTabPage();
			this.groupbox_expert = new blueshotGroupBox();
			this.checkbox_reuseeditor = new blueshotCheckBox();
			this.checkbox_minimizememoryfootprint = new blueshotCheckBox();
			this.checkbox_checkunstableupdates = new blueshotCheckBox();
			this.checkbox_suppresssavedialogatclose = new blueshotCheckBox();
			this.label_counter = new blueshotLabel();
			this.textbox_counter = new blueshotTextBox();
			this.label_footerpattern = new blueshotLabel();
			this.textbox_footerpattern = new blueshotTextBox();
			this.checkbox_thumbnailpreview = new blueshotCheckBox();
			this.checkbox_optimizeforrdp = new blueshotCheckBox();
			this.checkbox_autoreducecolors = new blueshotCheckBox();
			this.label_clipboardformats = new blueshotLabel();
			this.checkbox_enableexpert = new blueshotCheckBox();
		...
		private blueshotCheckBox checkbox_notifications;
		private blueshotCheckBox checkbox_minimizememoryfootprint;
		private System.Windows.Forms.ColumnHeader destination;
		private blueshotCheckBox checkbox_picker;
		private System.Windows.Forms.ListView listview_destinations;
		private blueshotGroupBox groupbox_editor;
		private blueshotCheckBox checkbox_editor_match_capture_size;
		private System.Windows.Forms.NumericUpDown numericUpDown_daysbetweencheck;
		private blueshotGroupBox groupbox_network;
		private blueshotCheckBox checkbox_usedefaultproxy;
		private blueshotLabel label_checkperiod;
		...
		private blueshotLabel label_fullscreen_hotkey;
		private blueshotLabel label_window_hotkey;
		private blueshotLabel label_region_hotkey;
		private HotkeyControl lastregion_hotkeyControl;
		private blueshotLabel label_lastregion_hotkey;
		private blueshotGroupBox groupbox_hotkeys;
		private ColorButton colorButton_window_background;
		private blueshotRadioButton radiobuttonWindowCapture;
		private blueshotGroupBox groupbox_capture;
		private blueshotGroupBox groupbox_windowscapture;
		private blueshotTabPage tab_capture;
		...
		private blueshotLabel label_waittime;
		private blueshotRadioButton radiobuttonInteractiveCapture;
		private blueshotCheckBox checkbox_capture_mousepointer;
		private blueshotTabPage tab_printer;
		private System.Windows.Forms.ListView listview_plugins;
		private blueshotButton button_pluginconfigure;
		private blueshotGroupBox groupbox_plugins;
		private blueshotTabPage tab_plugins;
		private System.Windows.Forms.Button btnPatternHelp;
		private blueshotCheckBox checkbox_copypathtoclipboard;
		private blueshotTabPage tab_output;
		private blueshotTabPage tab_general;
		private System.Windows.Forms.TabControl tabcontrol;
		private blueshotCheckBox checkbox_autostartshortcut;
		private blueshotGroupBox groupbox_destination;
		private blueshotCheckBox checkbox_alwaysshowqualitydialog;
		private System.Windows.Forms.TextBox textBoxJpegQuality;
		private blueshotLabel label_jpegquality;
		private System.Windows.Forms.TrackBar trackBarJpegQuality;
		private blueshotGroupBox groupbox_qualitysettings;
		private blueshotGroupBox groupbox_applicationsettings;
		private blueshotGroupBox groupbox_preferredfilesettings;
		private blueshotCheckBox checkbox_playsound;
		private blueshotLabel label_primaryimageformat;
		private blueshotComboBox combobox_primaryimageformat;
		private System.Windows.Forms.ComboBox combobox_language;
		private blueshotLabel label_language;
		private blueshotTextBox textbox_screenshotname;
		private blueshotLabel label_screenshotname;
		private System.Windows.Forms.Button browse;
		private System.Windows.Forms.FolderBrowserDialog folderBrowserDialog1;
		private blueshotButton settings_cancel;
		private blueshotButton settings_confirm;
		private blueshotTextBox textbox_storagelocation;
		private blueshotLabel label_storagelocation;
		private blueshotTabPage tab_destinations;
		private blueshotTabPage tab_expert;
		private blueshotGroupBox groupbox_expert;
		private blueshotLabel label_clipboardformats;
		private blueshotCheckBox checkbox_enableexpert;
		private System.Windows.Forms.ListView listview_clipboardformats;
		private System.Windows.Forms.ColumnHeader columnHeader1;
		private blueshotCheckBox checkbox_autoreducecolors;
		private blueshotCheckBox checkbox_optimizeforrdp;
		private blueshotCheckBox checkbox_thumbnailpreview;
		private blueshotLabel label_footerpattern;
		private blueshotTextBox textbox_footerpattern;
		private blueshotLabel label_counter;
		private blueshotTextBox textbox_counter;
		private blueshotCheckBox checkbox_reducecolors;
		private blueshotCheckBox checkbox_suppresssavedialogatclose;
		private blueshotCheckBox checkbox_checkunstableupdates;
        private blueshotCheckBox checkbox_reuseeditor;
        private blueshotCheckBox checkbox_alwaysshowprintoptionsdialog;
        private blueshotGroupBox groupBoxColors;
        private blueshotCheckBox checkboxPrintInverted;
        private blueshotRadioButton radioBtnColorPrint;
        private blueshotRadioButton radioBtnGrayScale;
        private blueshotRadioButton radioBtnMonochrome;
        private blueshotGroupBox groupBoxPrintLayout;
        private blueshotCheckBox checkboxDateTime;
        private blueshotCheckBox checkboxAllowShrink;
        private blueshotCheckBox checkboxAllowEnlarge;
        private blueshotCheckBox checkboxAllowRotate;
        private blueshotCheckBox checkboxAllowCenter;
		private blueshotCheckBox checkbox_zoomer;
		private blueshotLabel label_icon_size;
