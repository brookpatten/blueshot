...
namespace blueshot.Forms
{
    ...
    public partial class SettingsForm : BaseForm
    {
        ...
        {
            if (!SimpleServiceProvider.Current.GetAllInstances<IblueshotPlugin>().Any())
            {
        ...
        private void DisplayTextBoxValidity(blueshotTextBox textbox, bool valid)
        {
            if (valid)
            {
        ...
        private void BrowseClick(object sender, EventArgs e)
        {
            ...
            {
                // This can happen when blueshot was launched under a system/service account (e.g. after an
