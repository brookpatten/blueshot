    ...
    public sealed partial class SharingForm : BaseForm
    {
        ...
        private async void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            try
            {
                ...
                // Capture itself
                string uniqueFileName = $"blueshot_share_{shareGuid}.png";
                ...
                dataPackage.Properties.ApplicationName = "blueshot";
        ...
        private void CleanupOldShareFiles()
        {
            try
            {
                ...
                string[] oldFiles = Directory.GetFiles(tempDir, "blueshot_share_*.png");
