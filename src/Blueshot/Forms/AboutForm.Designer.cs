...
namespace blueshot.Forms {
	partial class AboutForm {
		...
		private void InitializeComponent() {
			...
			this.lblLicense = new blueshotLabel();
			this.lblHost = new blueshotLabel();
			...
			this.lblBugs = new blueshotLabel();
			this.linkLblDonations = new System.Windows.Forms.LinkLabel();
			this.lblDonations = new blueshotLabel();
			this.linkLblIcons = new System.Windows.Forms.LinkLabel();
			this.lblIcons = new blueshotLabel();
			this.linkLabel1 = new System.Windows.Forms.LinkLabel();
			this.pictureBox1 = new System.Windows.Forms.PictureBox();
			this.lblTranslation = new blueshotLabel();
			...
			this.lblTitle.Text = "blueshot x.x.xxx";
			// 
			// lblLicense
			// 
			...
			this.linkLblHost.Text = "https://github.com/blueshot/blueshot";
			...
			this.linkLblBugs.Text = "https://getblueshot.org/tickets";
            this.linkLblBugs.Tag = "https://getblueshot.org/tickets/?version=" + EnvironmentInfo.GetblueshotVersion(true);
			...
			this.linkLblDonations.Text = "https://getblueshot.org/support";
            this.linkLblDonations.Tag = "https://getblueshot.org/support/?version=" + EnvironmentInfo.GetblueshotVersion(true);
			...
			this.linkLabel1.Text = "https://getblueshot.org";
			this.linkLabel1.TextAlign = System.Drawing.ContentAlignment.TopLeft;
            this.linkLabel1.Tag = "https://getblueshot.org/?version=" + EnvironmentInfo.GetblueshotVersion(true);
		...
		private blueshotLabel lblTranslation;
		private blueshotLabel lblHost;
		private blueshotLabel lblDonations;
		private blueshotLabel lblBugs;
		private blueshotLabel lblIcons;
		private blueshotLabel lblLicense;
	}
}
