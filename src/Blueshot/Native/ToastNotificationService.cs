...
namespace blueshot.Plugin.Win10
{
    /// <summary>
    ...
    public class ToastNotificationService : INotificationService
    {
        ...
        public ToastNotificationService()
        {
            ...
            {
                Log.Info("blueshot was activated due to a toast.");
            }
            ...
            var localAppData = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "blueshot");
            if (!Directory.Exists(localAppData))
            {
                Directory.CreateDirectory(localAppData);
            }

            _imageFilePath = Path.Combine(localAppData, "blueshot.png");
            ...
            using var blueshotImage = blueshotResources.GetblueshotIcon().ToBitmap();
            blueshotImage.Save(_imageFilePath, ImageFormat.Png);
        }
