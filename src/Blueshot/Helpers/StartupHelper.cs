...
namespace blueshot.Helpers
{
    ...
    public static class StartupHelper
    {
        ...
        private const string ApplicationName = "blueshot";
        ...
        /// </summary>
        /// <returns>true if blueshot can write key</returns>
        ...
        /// <summary>
        /// Return true if the local machine has a RUN entry for blueshot
        /// </summary>
        ...
        /// <summary>
        /// Return true if the current user has a RUN entry for blueshot
        /// </summary>
        /// <returns>true if there is a run key</returns>
