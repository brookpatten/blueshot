...
using blueshot.Helpers.Entities;
using log4net;
...
namespace blueshot.Helpers
{
    ...
    public class UpdateService
    {
        ...
        private static readonly Uri UpdateFeed = new Uri("https://getblueshot.org/update-feed.json");
        private static readonly Uri Downloads = new Uri("https://getblueshot.org/downloads");
