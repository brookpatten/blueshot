...
namespace blueshot.Base.Controls
{
    ...
    /// </summary>
    public class blueshotForm : Form, IblueshotLanguageBindable
    {
        private static readonly ILog LOG = LogManager.GetLogger(typeof(blueshotForm));
...
#if DEBUG
        [Category("blueshot"), DefaultValue(null), Description("Specifies key of the language file to use when displaying the text.")]
#endif
        ...
        protected void InitializeForDesigner()
        {
            ...
            try
            {
                ...
                // Language.AddLanguageFilePath(@"C:\blueshot\blueshot\Languages");
                ...
                if (assemblyDirectory != null && !Language.AddLanguageFilePath(Path.Combine(assemblyDirectory, @"..\..\blueshot\Languages\")))
                {
                    Language.AddLanguageFilePath(Path.Combine(assemblyDirectory, @"..\..\..\blueshot\Languages\"));
                }
        ...
        {
            // Every blueshotForm should have it's default icon
        ...
        /// <summary>
        /// check if the form was closed with an OK, if so store the values in the blueshotControls
        /// </summary>
        /// <param name="e"></param>
        ...
        protected void ApplyLanguage(ToolStripItem applyTo, string languageKey)
        {
            ...
            else
            {
                ...
                if (!DesignMode)
                {
                    LOG.DebugFormat("blueshot control without language key: {0}", applyTo.Name);
                }
            }
        }
        ...
        {
            if (applyTo is IblueshotLanguageBindable languageBindable)
            {
        ...
        {
            if (applyTo is not IblueshotLanguageBindable languageBindable)
            {
            ...
            if (applyTo is not (IblueshotConfigBindable configBindable and blueshotComboBox comboxBox)) return;
        ...
        /// <summary>
        /// Apply all the language settings to the "blueshot" Controls on this form
        /// </summary>
        protected void ApplyLanguage()
        {
            ...
            try
            {
                ...
                // Reset the text values for all blueshotControls
        ...
        /// <summary>
        /// Fill all blueshotControls with the values from the configuration
        /// </summary>
        private void FillFields()
        {
            foreach (FieldInfo field in GetCachedFields(GetType()))
            {
                ...
                IblueshotConfigBindable configBindable = controlObject as IblueshotConfigBindable;
                ...
                if (controlObject is blueshotComboBox comboxBox)
                {
        ...
        /// <summary>
        /// Store all blueshotControl values to the configuration
        /// </summary>
