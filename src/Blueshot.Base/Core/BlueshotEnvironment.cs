...
{
    /// <summary>
    /// Holds runtime environment state for blueshot that is determined at startup
    /// and shared across the application.
    /// </summary>
    public static class blueshotEnvironment
    {
        /// <summary>
        /// Gets a value indicating whether blueshot is running in PortableApp (PAF) mode.
        /// Set to <c>true</c> when the standard PortableApp directory structure
        /// (<c>App\blueshot</c> next to the executable) is detected at startup.
        /// </summary>
        public static bool IsPortable { get; set; }

        /// <summary>
        /// Gets the full path of the active <c>blueshot.ini</c> configuration file.
