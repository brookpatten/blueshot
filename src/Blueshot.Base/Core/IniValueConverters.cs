...
{
    /// <summary>
    /// Registers all custom Dapplo.Ini value converters required by blueshot's
    ...
    public static class IniValueConverters
    {
        ...
        /// <summary>
        /// Registers all blueshot-specific value converters with
        ...
        public static void Register()
        {
            ...
            ValueConverterRegistry.Register(new blueshotObjectValueConverter());
        }
    }
    ...
    /// format is identical to what the old blueshot code produced (named colours such
    ...
    ///
    /// The format is the one produced by the old blueshot IniFile subsystem:
    ...
    /// </summary>
    public sealed class blueshotObjectValueConverter : ValueConverterBase<object>
    {
        ...
        public override string ConvertToString(object value)
        {
            ...
            // Build assembly qualifier, abbreviated for blueshot assemblies
            var assemblyName = type.Assembly.FullName ?? string.Empty;
            if (assemblyName.StartsWith("blueshot", StringComparison.OrdinalIgnoreCase))
            {
