...
namespace blueshot.Base.Core
{
    ...
    public class Language
    {
        ...
        static Language()
        {
            if (!IniConfigRegistry.TryGet("blueshot.ini", out _))
            {
                ...
                IniConfigRegistry.ForFile("blueshot.ini")
            ...
            try
            {
                ...
                {
                    AddPath(Path.Combine(applicationFolder, @"App\blueshot\Languages"));
                }

                // Application data path
                string applicationDataFolder = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
                AddPath(Path.Combine(applicationDataFolder, @"blueshot\Languages\"));
