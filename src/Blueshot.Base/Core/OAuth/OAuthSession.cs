...
namespace blueshot.Base.Core.OAuth
{
    /// <summary>
    ...
    public class OAuthSession
    {
        ...
        private string _userAgent = "blueshot";
        ...
        public string CallbackUrl { get; set; } = "https://getblueshot.org";

        public bool CheckVerifier { get; set; } = true;

        public Size BrowserSize { get; set; } = new Size(864, 587);

        public string LoginTitle { get; set; } = "Authorize blueshot access";
