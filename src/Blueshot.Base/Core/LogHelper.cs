...
namespace blueshot.Base.Core
{
    ...
    public class LogHelper
    {
        ...
        private const string InitMessage = "blueshot initialization of log system failed";
        ...
        public static string InitializeLog4Net()
        {
            ...
            {
                "log4net.xml", @"App\blueshot\log4net-portable.xml"
            })
            {
            ...
            if (!_isLog4NetConfigured)
            {
                try
                {
                    ...
                    using Stream stream = assembly.GetManifestResourceStream("blueshotPlugin.log4net-embedded.xml");
