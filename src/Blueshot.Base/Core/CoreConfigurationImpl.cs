...
namespace blueshot.Base.Core
{
    public partial class CoreConfigurationImpl : ICoreConfiguration
    {
        ...
        private string CreateOutputFilePath()
        {
            ...
            {
                string pafOutputFilePath = Path.Combine(Application.StartupPath, @"..\..\Documents\Pictures\blueshots");
        ...
        public void ValidateAndCorrectOutputFileAsFullpath()
        {
            ...
            {
                OutputFileAsFullpath = blueshotEnvironment.IsPortable
                    ? Path.Combine(Application.StartupPath, @"..\..\Documents\Pictures\blueshots\dummy.png")
