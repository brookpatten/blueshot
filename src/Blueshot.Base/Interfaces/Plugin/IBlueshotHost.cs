...
{
    /// <summary>
    /// This interface is the blueshotPluginHost, that which "Hosts" the plugin.
    /// For blueshot this is implemented in the PluginHelper
    /// </summary>
    public interface IblueshotHost
    {
        /// <summary>
        /// Create a Thumbnail
        /// </summary>
