...
using blueshot.Plugin.Office.OfficeExport;
using Microsoft.Office.Interop.Outlook;
using Microsoft.Win32;

namespace blueshot.Plugin.Office.Destinations
{
    /// <summary>
    ...
    public class OutlookDestination : AbstractDestination
    {
        ...
        private static readonly Image MailIcon = blueshotResources.GetImage("Email.Image");
        ...
        public override ExportInformation ExportCapture(bool manuallyInitiated, ISurface surface, ICaptureDetails captureDetails)
        {
            ...
            {
                tmpFile = ImageIO.SaveNamedTmpFile(surface, captureDetails, new SurfaceOutputSettings().PreventblueshotFormat());
            }
            else
            {
            ...
            if (string.IsNullOrEmpty(attachmentName))
            {
                attachmentName = "blueshot Capture";
            }
