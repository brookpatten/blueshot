...
//  The blueshot project is hosted on GitHub: https://github.com/blueshot
// 
...
using Dapplo.Ini;
using blueshot.Plugin.Office.Com;
using blueshot.Plugin.Office.OfficeInterop;
using Microsoft.Office.Core;
using Microsoft.Office.Interop.Word;
using Version = System.Version;

namespace blueshot.Plugin.Office.OfficeExport
{
    /// <summary>
