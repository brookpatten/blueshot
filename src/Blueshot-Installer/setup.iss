...
#define SolutionDir ".."
#define blueshotProjectDir "..\blueshot"
#define LanguagesDir "..\blueshot\Languages"
#define BinDir "bin\Release\net480"
#define ReleaseDir "..\blueshot\bin\Release\net480"
#define PluginDir "..\blueshot\bin\Release\net480\Plugins"
#define CertumThumbprint GetEnv('CertumThumbprint')
#define DefaultInstallFlags "overwritereadonly ignoreversion"

[Files]
Source: {#ReleaseDir}\blueshot.exe; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\blueshot.Base.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\blueshot.Editor.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\blueshot.exe.config; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\log4net.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\log4net.xml; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\Dapplo.*.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\SixLabors.ImageSharp.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\SixLabors.ImageSharp.Drawing.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\SixLabors.Fonts.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\System.*.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\Svg.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\ExCSS.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\HtmlAgilityPack.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\Newtonsoft.Json.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\Microsoft.Toolkit.*.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\Microsoft.IO.RecyclableMemoryStream.dll; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\checksum.SHA256; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\Twemoji.Mozilla.ttf; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: {#ReleaseDir}\emojis.xml; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: additional_files\installer.txt; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: additional_files\license.txt; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}
Source: additional_files\readme.txt; DestDir: {app}; Components: blueshot; Flags: {#DefaultInstallFlags}

; Core language files
Source: {#LanguagesDir}\*nl-NL*; Excludes: "*installer*,*website*"; DestDir: {app}\Languages; Components: blueshot; Flags: {#DefaultInstallFlags};
Source: {#LanguagesDir}\*en-US*; Excludes: "*installer*,*website*"; DestDir: {app}\Languages; Components: blueshot; Flags: {#DefaultInstallFlags};
Source: {#LanguagesDir}\*de-DE*; Excludes: "*installer*,*website*"; DestDir: {app}\Languages; Components: blueshot; Flags: {#DefaultInstallFlags};
...
;Office Plugin
Source: {#PluginDir}\blueshot.Plugin.Office\blueshot.Plugin.Office.dll; DestDir: {app}\Plugins\Office; Components: plugins\office; Flags: {#DefaultInstallFlags};
;JIRA Plugin
Source: {#PluginDir}\blueshot.Plugin.Jira\*Jira*.dll; DestDir: {app}\Plugins\Jira; Components: plugins\jira; Flags: {#DefaultInstallFlags};
...
Source: {#PluginDir}\blueshot.Plugin.ExternalCommand\blueshot.Plugin.ExternalCommand.dll; DestDir: {app}\Plugins\ExternalCommand; Components: plugins\externalcommand; Flags: {#DefaultInstallFlags};
Source: {#SolutionDir}\blueshot.Plugin.ExternalCommand\Languages\language_externalcommand*.xml; DestDir: {app}\Languages\Plugins\ExternalCommand; Components: plugins\externalcommand; Flags: {#DefaultInstallFlags};

[Setup]
; changes associations is used when the installer installs new extensions, it clears the explorer icon cache
ChangesAssociations=yes
; Use the Windows Restart Manager to close blueshot gracefully before installation (triggering
...
AppPublisherURL=https://getblueshot.org
AppSupportURL=https://getblueshot.org
AppUpdatesURL=https://getblueshot.org
...
SetupIconFile=..\blueshot\icons\applicationIcon\icon.ico
#if CertumThumbprint  != ""
...
Root: HKCU; Subkey: Software\Classes\.blueshot; ValueType: none; ValueName: {#ExeName}; Flags: deletevalue noerror;
Root: HKCU; Subkey: Software\Classes\blueshot; ValueType: none; ValueName: {#ExeName}; Flags: deletevalue noerror;
; HKEY_LOCAL_MACHINE - for all users when admin (with the noerror this doesn't matter)
Root: HKLM; Subkey: Software\Classes\.blueshot; ValueType: none; ValueName: {#ExeName}; Flags: deletevalue noerror;
Root: HKLM; Subkey: Software\Classes\blueshot; ValueType: none; ValueName: {#ExeName}; Flags: deletevalue noerror;
...
Root: HKA; Subkey: Software\Classes\.blueshot; ValueType: string; ValueName: ""; ValueData: "blueshot"; Flags: uninsdeletevalue noerror
Root: HKA; Subkey: Software\Classes\blueshot; ValueType: string; ValueName: ""; ValueData: "blueshot File"; Flags: uninsdeletevalue noerror
Root: HKA; Subkey: Software\Classes\blueshot\DefaultIcon; ValueType: string; ValueName: ""; ValueData: """{app}\blueshot.EXE,0"""; Flags: uninsdeletevalue noerror
Root: HKA; Subkey: Software\Classes\blueshot\shell\open\command; ValueType: string; ValueName: ""; ValueData: """{app}\blueshot.EXE"" --openfile ""%1"""; Flags: uninsdeletevalue noerror
...
en.startblueshot=Start {#ExeName}
...
de.startblueshot={#ExeName} starten
...
es.startblueshot=Lanzar {#ExeName}
...
fi.startblueshot=Käynnistä {#ExeName}
...
it.startblueshot=Esegui {#ExeName}
...
lt.startblueshot=Palaist {#ExeName}
...
nl.startblueshot={#ExeName} starten
...
nn.startblueshot=Start {#ExeName}
...
ru.startblueshot=Запустить {#ExeName}
...
sr.startblueshot=Покрени Гриншот
...
tr.startblueshot={#ExeName} uygulamasını başlat
...
uk.startblueshot=Запустити {#ExeName}
...
// Build a list of blueshot parameters from the supplied installer parameters
...
/////////////////////////////////////////////////////////////////////
// Restart manager support. This is needed to restart blueshot after installation, if it was running when the installer was launched.
/////////////////////////////////////////////////////////////////////
var
...
[Run]
Filename: "{app}\{#ExeName}.exe"; Description: "{cm:startblueshot}"; Parameters: "{code:GetParamsForGS}"; WorkingDir: "{app}"; Flags: nowait postinstall runasoriginaluser; Check: NotAlreadyRestarted
Filename: "https://getblueshot.org/thank-you/?language={language}&version={#Version}"; Flags: shellexec runasoriginaluser

[InstallDelete]
// processed as the first step of installation.
// Delete plugins from blueshot 1.2
// Type: filesandordirs; Name: "{app}\Plugins\blueshotBoxPlugin"
Type: filesandordirs; Name: "{app}\Plugins\blueshotConfluencePlugin"
// Type: filesandordirs; Name: "{app}\Plugins\blueshotDropboxPlugin"
Type: filesandordirs; Name: "{app}\Plugins\blueshotExternalCommandPlugin"
// Type: filesandordirs; Name: "{app}\Plugins\blueshotFlickrPlugin"
// Type: filesandordirs; Name: "{app}\Plugins\blueshotImgurPlugin"
Type: filesandordirs; Name: "{app}\Plugins\blueshotJiraPlugin"
Type: filesandordirs; Name: "{app}\Plugins\blueshotOCRPlugin"
Type: filesandordirs; Name: "{app}\Plugins\blueshotOfficePlugin"
// Type: filesandordirs; Name: "{app}\Plugins\blueshotPhotobucketPlugin"
// Type: filesandordirs; Name: "{app}\Plugins\blueshotPicasaPlugin"

// Portable plugin directories
// Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Box"
Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Confluence"
// Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Dropbox"
Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.ExternalCommand"
// Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Flickr"
// Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.GooglePhotos"
// Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Imgur"
Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Jira"
Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Office"
// Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Photobucket"
Type: filesandordirs; Name: "{app}\Plugins\blueshot.Plugin.Win10"
