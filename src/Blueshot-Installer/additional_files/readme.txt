blueshot: A screenshot tool optimized for productivity.
...
All details to our tickets can be found here: https://github.com/blueshot/blueshot/issues or, for older tickets: https://blueshot.atlassian.net
...
Bugs fixed:
* File Association and Launch with File Arguments Not Working When Already Running [#685](https://github.com/blueshot/blueshot/issues/685) thanks to @Christian-Schulz
* ZIP Releases are Missing [#609](https://github.com/blueshot/blueshot/issues/609) thanks to @Christian-Schulz
...
Bugs fixed:
* blueshot.ini: Exclude Plugins and Include Plugins setting broken [#648](https://github.com/blueshot/blueshot/issues/648) [#642](https://github.com/blueshot/blueshot/issues/642) thanks to @Christian-Schulz for providing the fix
...
Bugs fixed
* Fix Administrative installation via user interface [#546](https://github.com/blueshot/blueshot/issues/546) [#611](https://github.com/blueshot/blueshot/issues/611) [#598](https://github.com/blueshot/blueshot/issues/598)

Features added:
* Installer: Allow Choice between All-Users (Administrative) and Current-User Installation [#625](https://github.com/blueshot/blueshot/pull/625)

# blueshot 1.3.292

Bugs fixed:
* Fix Administrative installation via command line using /ALLUSERS [#601](https://github.com/blueshot/blueshot/issues/601) [#619](https://github.com/blueshot/blueshot/issues/619) 
...
blueshot 1.3 is the first blueshot which targets .NET 4.7.2 which just by doing to solves some general issues in the area of Internet Explorer capturing, TLS communication and some other minor issues.

We've also added some new Windows 10 functions, like notifications, OCR and sharing with Windows 10 apps.

## Supported platforms:
As always blueshot comes "as-is" with no guarantee whatsoever, we are not paid enough to make this possible.
Due to the amount of work involved in testing blueshot on different platforms, and needing hardware to do so, we cannot support all of them. What does this mean?

* Windows 10 "current" - We develop & test blueshot on the latest available version of Windows 10, which means you can pretty much assume it works on there and if not we can work on it.
...
* Windows 10 insiders - If someone is on an insider, and wants to use blueshot, there is no guarantee. But please do report issues, and make sure you mention the build you are on. As insiders are the next "current", we will try to look at this.
...
* Windows 8 - blueshot 1.2 mostly worked on it, thus we assume 1.3 will do so too, but we cannot support this.
...
* Linux via Wine or CrossOver - Although we made some small changes to blueshot to get basics working, it's not supported and to be honest it's a lot of work to get it running, and the result is very disappointed.
* MacOS - We have a version of blueshot for MacOS in the appstore [here](https://apps.apple.com/us/app/blueshot/id1103915944).

## Support for other software?
We have many request, mainly from companies in form of "we use an eMail client from this company, and have a tool which does this cool thing, can you support this?" This depends, if it's something which benefits the masses, we can look at it. An example is PowerToys, where we [interact with the maintainers](https://github.com/microsoft/PowerToys/wiki/Application-Compatibility) to see how we can make blueshot work together and not have PowerToys break us. We can't support all, and we cannot buy licenses & install every product.

## Let us see the changes:

### New features
* The editor now has a zoom, completely build by our awesome community member @KillyMXI PR #201 
* Windows 10 has out of the box OCR support, this can now be used from blueshot. We added functionality which is on par with that we provided via an old Microsoft component called "MODI". To reduce our maintenance, we removed the old functionality. This is the first step with Windows 10 OCR, we have some great plans with this.
* blueshot can now use the Windows 10 app sharing, share screenshots with app which support bitmaps.
* blueshot now can use the Windows 10 notifications system, which looks better. We will add more user friendly functionality for this later.
* [FEATURE-1110](https://blueshot.atlassian.net/browse/FEATURE-1110): Making it possible to use a hotkey to open the clipboard, for details look at the issue.
...
* DPI improvements, so people can use blueshot with high DPI screens.
...
* Changed the cloud services Box, DropBox and Imgur to use the default browser in combination with getblueshot.org instead of the embedded, solving incompatibility issues.

### Bug fixes

#### Functionality fixes:
* [BUG-2693](https://blueshot.atlassian.net/browse/BUG-2693), [BUG-2693](https://blueshot.atlassian.net/browse/BUG-2693), [BUG-2743](https://blueshot.atlassian.net/browse/BUG-2743): blueshot doesn't recognize a MAPI client
* [BUG-2535](https://blueshot.atlassian.net/browse/BUG-2535): blueshot selects invisible windows fix was suggested by Raymond Chen [here](https://devblogs.microsoft.com/oldnewthing/20200302-00/?p=103507)
* [BUG-2544](https://blueshot.atlassian.net/browse/BUG-2544): Enabled TLS1.1 & 1.2 to fix jira connectivity and do not use the JIRA session support as this was deprecated.
* [BUG-2529](https://blueshot.atlassian.net/browse/BUG-2529): This should most likely fix the excessive update checks.
* [BUG-1919](https://blueshot.atlassian.net/browse/BUG-1919): Screenshot works once on Internet Explorer
* [BUG-1943](https://blueshot.atlassian.net/browse/BUG-1943): Picassa no longer supported by Google - Picassa plugin update to Google Photos
* [BUG-2127](https://blueshot.atlassian.net/browse/BUG-2127): Incorrect link image to picasa
* [BUG-2170](https://blueshot.atlassian.net/browse/BUG-2170): Editor buttons are too small on high-resolution PC
* [BUG-2300](https://blueshot.atlassian.net/browse/BUG-2300): User need to do a lot of CTRL + Z to undo the ellipse/rectangle modification
* [BUG-2736](https://blueshot.atlassian.net/browse/BUG-2736): Cropping a capture where a speech bubble is shown doesn't move the bubble tail
...
#### Stability fixes:
* [BUG-2644](https://blueshot.atlassian.net/browse/BUG-2644): Fixed a NPRE when exporting to Powerpoint when it's not running yet.
* [BUG-2542](https://blueshot.atlassian.net/browse/BUG-2542): Fix for shutdown issue (ImgurPlugin)
* [BUG-2249](https://blueshot.atlassian.net/browse/BUG-2249): Error after switching between colors
* [BUG-2303](https://blueshot.atlassian.net/browse/BUG-2303): blueshot 1.2.10 Build 6 (64 bit) - Dotnet 4.0 framework crash.
* [BUG-2307](https://blueshot.atlassian.net/browse/BUG-2307): Using the pencil tool, changing colors, undo, pencil tool again, produces error dump.
* [BUG-2309](https://blueshot.atlassian.net/browse/BUG-2309): Exception while editing screen shot
* [BUG-2403](https://blueshot.atlassian.net/browse/BUG-2403): error message came up immediately after a restart of Windows.
* [BUG-2435](https://blueshot.atlassian.net/browse/BUG-2435): Crash
* [BUG-2463](https://blueshot.atlassian.net/browse/BUG-2463): Crash on moving freehand drawing
* [BUG-2484](https://blueshot.atlassian.net/browse/BUG-2484): Unexpected error pop-up after DRIVER VERIFIER IOMANAGER VIOLATION Blue Screen of Death
* [BUG-2486](https://blueshot.atlassian.net/browse/BUG-2486): program window goes white with red x through it
* [BUG-2552](https://blueshot.atlassian.net/browse/BUG-2552): Crashed when drawing new colored line after a ctrl+z undo.
* [BUG-2557](https://blueshot.atlassian.net/browse/BUG-2557): sudden shut down due to error , Error
* [BUG-2567](https://blueshot.atlassian.net/browse/BUG-2567): Automatic error, tells me to report a bug
* [BUG-2577](https://blueshot.atlassian.net/browse/BUG-2577): Erreur inattendue
* [BUG-2592](https://blueshot.atlassian.net/browse/BUG-2592): Crash when copying to clipboard
* [BUG-2615](https://blueshot.atlassian.net/browse/BUG-2615): blueshot crashed while changing line color
* [BUG-2642](https://blueshot.atlassian.net/browse/BUG-2642): blueshot Image Editor crashed when I clicked "undo"
* [BUG-2654](https://blueshot.atlassian.net/browse/BUG-2654): GS crashing when logging off from a Windows account right after logging-on
* [BUG-2669](https://blueshot.atlassian.net/browse/BUG-2669): Exception on startup of blueshot
* [BUG-2684](https://blueshot.atlassian.net/browse/BUG-2684): Freehand tool causes crash after color change & undo
* [BUG-2698](https://blueshot.atlassian.net/browse/BUG-2698): Imgur: Object reference not set to an instance of an object.
* [BUG-2699](https://blueshot.atlassian.net/browse/BUG-2699): Crash on deleting a line path
* [BUG-2700](https://blueshot.atlassian.net/browse/BUG-2700): Imgur: Continued Error
* [BUG-2703](https://blueshot.atlassian.net/browse/BUG-2703): Crash dump: "Message: The notification platform is unavailable."
* [BUG-2707](https://blueshot.atlassian.net/browse/BUG-2707): Moving or editing object (usually cursor object) occasionally crashes blueshot
* #246,[BUG-2448](https://blueshot.atlassian.net/browse/BUG-2448), [BUG-2593](https://blueshot.atlassian.net/browse/BUG-2593), [BUG-2427](https://blueshot.atlassian.net/browse/BUG-2427), [BUG-2444](https://blueshot.atlassian.net/browse/BUG-2444), [BUG-2272](https://blueshot.atlassian.net/browse/BUG-2272): Inconsistent scale behavior when scaling objects with shift modifier


blueshot 1.2.10 RELEASE
...
blueshot 1.2.9.129-569de71 RELEASE

Bugs fixed:
* [BUG-2051] - Scroll-lock button not usable as hotkey
* [BUG-2056] - Cannot export to external command Paint.NET if .blueshot format is used
...
* [BUG-2120] - blueshot Editor Canvas Changed to White Screen
...
This is a bugfix release for the blueshot 1.2.9.104-3721c10 RELEASE
...
* BUG-2089 blueshot crashes when hotkey registration fails and OneDrive is not installed
* BUG-2091 blueshot .zip version has wrong log configuration

Features added:
* FEATURE-992 When reusing the editor, it is not brought to the front
* FEATURE-995 Paste images inside blueshot editor to the current cursor location
* FEATURE-998 Opening last capture in explorer should select/jump to the file
* FEATURE-1000 Set default focus on the OK-button in the blueshot quality dialog
...
* BUG-1892 blueshot saves blank JPG file with reduce colors
...
* BUG-1933 blueshot Installer sets bad registry key permission
...
* BUG-1945 Failure starting blueshot at system startup
* BUG-1949 Can't delete Imgur upload
* BUG-1965 Activation border around window is visible in the capture
* BUG-1991 blueshot portable (PAF) uses wrong log configuration
...
* BUG-2070 Installing blueshot deletes everything in the target directory
...
* FEATURE-958 blueshot is now using code signing certificates
...
This has Imgur improvements for the newer API version, this is a backport from blueshot 1.2.9
...
BUG-1527 / BUG-1848 / BUG-1850 / BUG-1851 / BUG-1859 : blueshot stops responding, hangs or crashes
...
* BUG-1655: blueshot uses the default proxy, even if the "use default proxy" check-box is not checked.
...
* External command: If a command outputs an URI this will be captured and placed on the clipboard, the behaviour currently can only be modified in the blueshot.ini
...
* FEATURE-757: blueshot will now store the last used region in the blueshot.ini, which makes it also available after a restart.
...
Changes:
* Optimized blueshots update check to use even less traffic by checking the time-stamp of the update feed before downloading it.
* JIRA: With JIRA 6.x using the SOAP (Webservice) API the access has gotten really slow, we improved the performance slightly by loading some information parallel. (In blueshot 2.x we will move to another API.)
...
* BUG-1620: blueshot crashing Chrome running in 'Windows 8 Mode'
...
* BUG-1709: Alignment of the text and speech-bubble wasn't always correctly saved in the .blueshot file
...
... and a lot more small bug fixes to make blueshot more stable.
...
* Unreported: The blueshot.ini values "NoGDICaptureForProduct" and "NoDWMCaptureForProduct" had incorrect defaults, which might cause issues with some applications when using the auto capture mode.
...
* FEATURE-712: The amount of colour which images are reduce to, if the setting is active, has been made configurable in the blueshot.ini property OutputFileReduceColorsTo. Default stays at 256,
* FEATURE-723: Adding a newline when exporting to Word or an open Outlook email, this makes it possible to repeat exports.

Changes:
* Flickr plug-in: from June 27th, 2014 Flickr will only accept uploads via HTTPS! As the switch is already possible blueshot has been changed accordingly.
...
* BUG-1600: Found that blueshot uses a wrong URL format on the clipboard, this fix might solve some issues
...
Bugs resolved (for bug details go to http://sourceforge.net/p/blueshot/bugs and search on the ID):
...
* BUG-1525, BUG-1486: blueshot looses configuration settings. (At least we hope this is resolved)
...
* FEATURE-596: Added commandline option "/inidirectory <directory>" to specify the location of the blueshot.ini, this can e.g. be used for multi-profiles...
* Removed reading the blueshot.ini if it was changed manually outside of blueshot while it is running, this should increase stability. People should now exit blueshot before modifying this file manually.
...
* Not reported: Annotations where not visible when exporting to Office destinations after writing in the blueshot format.
* Not reported: Removed the update check in blueshot for PortableApps
...
* General: blueshot now also comes as a "for PortableApps" download, this now will be released just like the other files (installer & .zip)
* Editor: Added a new image format "blueshot" which allows the user to save the current state and continue editing later. (was already in the 1.1.1.2550)
...
* BUG-1499: Stability improvements for when blueshot tries to open the explorer.exe
* BUG-1500: Error while dragging an obfuscation
* BUG-1504: InvalidCastException when using the brightness-filter
* Reported in forum: Fixed a problem with the OCR, it sometimes didn't work. See: http://sourceforge.net/p/blueshot/discussion/676082/thread/31a08c8c
* Not reported: Flickr configuration for the Family, Friend & Public wasn't stored.
* Not reported: If blueshot is linked in a Windows startup folder, the "Start with startup" checkbox wasn't checked.
...
Known issues:
* blueshot general: a captured I-Beam cursor isn't displayed correctly on the final result.
* blueshot general: Not all hotkeys can be changed in the editor. When you want to use e.g. the pause or the Windows key, you will need to be modified the ini directly.
* blueshot general: Can't capture 256 color screens
* blueshot general: Hotkeys don't function when a UAC (elevated) process is active. This we won't change as it is a Windows security measure.
* blueshot general: Capturing apps on Windows 8 when having more than one screen still causes some issues.
* blueshot editor: Rotate only rotates the screenshot, not the added elements or cursor


1.0.6 build 2228 Release

Some features we added since 0.8:
* General: blueshot will now run in 64 bit mode, if the OS supports it.
...
* General: Changed the configuration to use a .ini with some advanced features. Fixed settings can't be changed in the settings. Settings, quicksettings and the blueshot icon can be disabled. (See blueshot.ini and our website)
...
* General: Added an expert tab in the settings, here some blueshot behavior can be changed
...
* fixed capture bug which prevents a lot of people to use blueshot (in 0.7.9 this was a "GDI+" exception). Problem was due to allocating the bitmap in the memory of the graphic card which is not always big enough.
...
* Changed configuration loading to better support portable blueshot usage.
...
* Added "Drag to", you can now drag images or image files to the blueshot image editor.
...
* added options for launching blueshot on startup and for creating a desktop shortcut to settings dialog [ 1758908 ]
