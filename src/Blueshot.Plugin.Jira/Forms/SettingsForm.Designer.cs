...
using blueshot.Plugin.Jira;

namespace blueshot.Plugin.Jira.Forms; 
	partial class SettingsForm {
		...
		private void InitializeComponent()
		{
			...
			this.label_url = new blueshotLabel();
			this.textBoxUrl = new blueshotTextBox();
			this.combobox_uploadimageformat = new blueshotComboBox();
			this.label_upload_format = new blueshotLabel();
			this.SuspendLayout();
			// 
			// buttonOK
			// 
		...
		private blueshotComboBox combobox_uploadimageformat;
		private blueshotLabel label_upload_format;
		private blueshotTextBox textBoxUrl;
		private blueshotLabel label_url;
