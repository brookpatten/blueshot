...
namespace blueshot.Editor.Destinations
{
    /// <summary>
    ...
    public class EditorDestination : AbstractDestination
    {
        ...
        private static readonly Image blueshotIcon = blueshotResources.GetblueshotIcon().ToBitmap();
        ...
        public override Image DisplayIcon => blueshotIcon;
