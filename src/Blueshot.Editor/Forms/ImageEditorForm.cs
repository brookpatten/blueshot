...
namespace blueshot.Editor.Forms
{
    ...
    public partial class ImageEditorForm : EditorForm, IImageEditor
    {
        ...
        private blueshotToolStripButton[] _toolbarButtons;
        ...
        private void Initialize(ISurface surface, bool outputMade)
        {
            ...
            // to just the bare form language key ("blueshot editor").
        ...
        private void SetSurface(ISurface newSurface)
        {
            ...
            Image backgroundForTransparency = blueshotResources.GetImage("Checkerboard.Image");
            if (_surface != null)
            {
        ...
        /**
         * Interfaces for plugins, see blueshotInterface for more details!
         */
        ...
        private void UncheckAllToolButtons()
        {
            ...
            {
                foreach (blueshotToolStripButton butt in _toolbarButtons)
                {
                    butt.Checked = false;
                }
            }
        ...
        {
            var mainForm = SimpleServiceProvider.Current.GetInstance<IblueshotMainForm>();
            mainForm.ShowAbout();
        }
        ...
        private void SaveElementsToolStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            {
                Filter = "blueshot templates (*.gst)|*.gst",
        ...
        public bool TrySaveState(string filePath)
        {
            ...
            try
            {
                ImageIO.Save(_surface, filePath, true, new SurfaceOutputSettings(OutputFormat.blueshot), false);
