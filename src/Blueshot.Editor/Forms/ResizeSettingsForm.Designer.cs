...
namespace blueshot.Editor.Forms {
	partial class ResizeSettingsForm {
		...
		private void InitializeComponent() {
			...
			this.checkbox_aspectratio = new blueshotCheckBox();
			this.label_width = new blueshotLabel();
			this.label_height = new blueshotLabel();
		...
		private blueshotCheckBox checkbox_aspectratio;
		private blueshotLabel label_width;
		private blueshotLabel label_height;
