...
namespace blueshot.Editor.Forms {
	partial class TornEdgeSettingsForm {
		...
		private void InitializeComponent() {
			...
			this.buttonOK = new blueshotButton();
			this.buttonCancel = new blueshotButton();
			this.labelDarkness = new blueshotLabel();
			this.labelOffset = new blueshotLabel();
			this.labelThickness = new blueshotLabel();
			this.toothsize = new System.Windows.Forms.NumericUpDown();
			this.label_toothsize = new blueshotLabel();
			this.label_horizontaltoothrange = new blueshotLabel();
			this.horizontaltoothrange = new System.Windows.Forms.NumericUpDown();
			this.labelVerticaltoothrange = new blueshotLabel();
			this.verticaltoothrange = new System.Windows.Forms.NumericUpDown();
			this.top = new blueshotCheckBox();
			this.right = new blueshotCheckBox();
			this.bottom = new blueshotCheckBox();
			this.left = new blueshotCheckBox();
			this.shadowCheckbox = new blueshotCheckBox();
			this.all = new blueshotCheckBox();
		...
		private blueshotButton buttonOK;
		private blueshotButton buttonCancel;
		private blueshotLabel labelDarkness;
		private blueshotLabel labelOffset;
		private blueshotLabel labelThickness;
		private System.Windows.Forms.NumericUpDown toothsize;
		private blueshotLabel label_toothsize;
		private blueshotLabel label_horizontaltoothrange;
		private System.Windows.Forms.NumericUpDown horizontaltoothrange;
		private blueshotLabel labelVerticaltoothrange;
		private System.Windows.Forms.NumericUpDown verticaltoothrange;
		private blueshotCheckBox top;
		private blueshotCheckBox right;
		private blueshotCheckBox bottom;
		private blueshotCheckBox left;
		private blueshotCheckBox shadowCheckbox;
        private blueshotCheckBox all;
	}
}