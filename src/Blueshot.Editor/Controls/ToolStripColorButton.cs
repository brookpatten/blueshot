...
using ColorDialog = blueshot.Editor.Forms.ColorDialog;

namespace blueshot.Editor.Controls
{
    public class ToolStripColorButton : ToolStripButton, INotifyPropertyChanged, IblueshotLanguageBindable
    {
